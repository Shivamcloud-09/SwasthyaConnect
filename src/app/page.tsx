...
import { Stethoscope, Ambulance, Car, ClipboardPlus, Hospital, ListChecks, ArrowRight, type LucideIcon } from 'lucide-react';
...
const InlinedServiceCard = ({ icon: Icon, title, description, href }: ServiceCardProps) => (
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <InlinedServiceCard key={service.title} {...service} />
          ))}
        </div>
      </div>
    </div>
